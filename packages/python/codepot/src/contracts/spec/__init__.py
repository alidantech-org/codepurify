...
SpecPrimitiveType = PrimitiveType
SpecPrimitiveFormat = PrimitiveFormat
SpecContentStrategy = ContentStrategy
SpecQueryOperator = QueryOperator
SpecVisibilityLevel = FieldVisibilityLevel
SpecPersistenceMode = FieldPersistenceMode
SpecRelationKind = EntityRelationKind
SpecSecurityCredentialSource = SecurityCredentialSource
SpecSecurityCredentialFormat = SecurityCredentialFormat
SpecSecurityPolicyMode = SecurityPolicyMode
SpecHttpMethod = HttpMethod
SpecUrlEnv = UrlEnv
SpecUrlKind = UrlKind
SpecUrlProtocol = UrlProtocol
