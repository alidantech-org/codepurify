...
class DocumentModel {
  ...
  final DocumentModelCategory category;
  final DocumentModelStatus status;
  final DocumentModelFormat format;
  final num? maxSizeMB;
  final List<String>? requiredFields;
  final DocumentModelMeta? meta;
  final bool isActive;
  ...
  DocumentModel copyWith({
    ...
    String? description,
    String? documentType,
    DocumentModelCategory? category,
    DocumentModelStatus? status,
    DocumentModelFormat? format,
    num? maxSizeMB,
    List<String>? requiredFields,
    DocumentModelMeta? meta,
    bool? isActive,
    bool? isVerified,
    bool? isFeatured,
    bool? isMandatory,
  ...
  factory DocumentModel.fromJson(dynamic json) {
    ...
    return DocumentModel(
      ...
      category:
          DocumentModelCategory.fromValue(map['category']?.toString() ?? ""),
      status: DocumentModelStatus.fromValue(map['status']?.toString() ?? ""),
      format: DocumentModelFormat.fromValue(map['format']?.toString() ?? ""),
      ...
      requiredFields: map['requiredFields'] == null
          ...
          : ((map['requiredFields'] as List?) ?? [])
              ...
              .toList(),
      meta:
          map['meta'] == null ? null : DocumentModelMeta.fromJson(map['meta']),
