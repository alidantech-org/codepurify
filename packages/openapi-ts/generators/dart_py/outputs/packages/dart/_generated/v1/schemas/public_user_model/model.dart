...
class PublicUserModel {
  ...
  final String name;
  final String email;
  final PublicUserModelStatus status;
  final List<PublicUserModelRoles> roles;
  final String? phone;
  final String? avatar;
  ...
  PublicUserModel copyWith({
    ...
    String? name,
    String? email,
    PublicUserModelStatus? status,
    List<PublicUserModelRoles>? roles,
    String? phone,
    String? avatar,
    String? address,
    bool? isOnline,
  ...
  factory PublicUserModel.fromJson(dynamic json) {
    ...
    return PublicUserModel(
      ...
      status: PublicUserModelStatus.fromValue(map['status']?.toString() ?? ""),
      roles: ((map['roles'] as List?) ?? [])
          .map((item) => PublicUserModelRoles.fromValue(item.toString()))
          .toList(),
