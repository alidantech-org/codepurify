class GetAllRequiredDocumentsResponse {
  final bool success;
  ...
  const GetAllRequiredDocumentsResponse({
  ...
  factory GetAllRequiredDocumentsResponse.fromJson(dynamic json) {
    final map = Map<String, Object?>.from((json as Map?) ?? {});

    return GetAllRequiredDocumentsResponse(
