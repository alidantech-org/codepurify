...
ROW_SCHEMA_KIND_PREFIX = "Schema Kind: "
ROW_PATHS = "Paths"
...
# Presenter messages
MSG_UNKNOWN_SCHEMAS_DETECTED = "Unknown schemas detected. These need classifier improvement."
MSG_WROTE_INFERENCE_GRAPH = "Wrote inference graph: "
