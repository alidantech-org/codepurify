...
```hbs
{! entity.names.singular.casing.pascal !}
// Output: User

{! entity.names.plural.casing.pascal !}
// Output: Users
```
...
// File name
const fileName = "{! entity.names.casing.kebab !}.dto.ts";

// API endpoint
const endpoint = "/api/{! entity.names.plural.casing.kebab !}";
```
