...
```hbs
{! field.names.* !}      // Name transformations
{! field.flags.* !}      // Boolean flags
...
```hbs
{! field.names.original !}           // "firstName"
{! field.names.casing.camel !}        // "firstName"
{! field.names.casing.pascal !}       // "FirstName"
{! field.names.casing.snake !}        // "first_name"
{! field.names.casing.kebab !}        // "first-name"
```
...
```hbs
{! field.flags.is_string !}     // true for string fields
{! field.flags.is_number !}     // true for numeric fields
{! field.flags.is_boolean !}     // true for boolean fields
{! field.flags.is_date !}       // true for date fields
{! field.flags.is_nullable !}   // true for optional fields
{! field.flags.is_required !}   // true for required fields
{! field.flags.is_primary !}    // true for primary keys
{! field.flags.is_unique !}     // true for unique fields
```

## TypeScript Types

```hbs
{! field.typescript.type !}    // "string | null"
{! field.typescript.base_type !} // "string"
```
